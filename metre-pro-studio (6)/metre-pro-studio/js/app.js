...
function showNewProjectDialog() {
    let html = `
        ...
        <div class="dialog-content" style="max-height: 70vh; overflow-y: auto;">
            ...
            <div class="form-group">
                <label>Sujet :</label>
                <input type="text" id="inputSujet" placeholder="Sujet / Description du projet">
            </div>
            <div class="form-group">
                <label>Ville :</label>
...
function showProjectInfo(projectId) {
    ...
    let html = `
        ...
        <div class="dialog-content" style="max-height: 70vh; overflow-y: auto;">
            ...
            <div class="form-group">
                <label>Sujet :</label>
                <input type="text" id="editSujet" value="${project.metadata.sujet || ''}">
            </div>
            <div class="form-group">
                <label>Ville :</label>
...
function updateProjectInfo(projectId) {
    ...
    project.metadata.sujet = $('#editSujet').val().trim();
...
function updateDaysRemaining() {
    ...
    let heureStr = project.metadata.heureFin || '';
    ...
    let icon = '📅';
    let text = '';
    let heureDisplay = heureStr ? ` à ${heureStr}` : '';
    ...
    if (diffDays < 0) {
        ...
        color = '#e67e22';
        icon = '⏰';
        text = `Aujourd'hui${heureDisplay} - Fin du projet`;
    } else if (diffDays <= 7) {
        color = '#e67e22';
        icon = '⏰';
        text = `${diffDays} jour(s) restant(s)${heureDisplay}`;
    } else {
        color = '#27ae60';
        icon = '📅';
